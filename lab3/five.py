from one import grams_to_ounces, fahrenheit_to_celsius
from two import solve, filter_prime, sphere_volume, unique_elements
from three import reverse_sentence, is_palindrome, histogram
from four import guess_the_number
